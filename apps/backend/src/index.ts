...
const app = new Elysia()
  // 2. Modifikasi CORS (Ambil dari ENV)
  .use(
    cors({
  ...
  // 3. Tambahkan Proteksi onRequest untuk /users
  ...
  // 5. Tambahkan Endpoint Debug Prisma
  .get("/debug-prisma", () => {
...
// 6. Logika Listen & Console Log Dynamic
...
// 7. Export Default (Wajib untuk Vercel)
export default app;
